...
/**
 * Test case for class \PHTH\Dracv\Domain\Model\Related.
 *
 ...
 */
class RelatedTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \PHTH\Dracv\Domain\Model\Related
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \PHTH\Dracv\Domain\Model\Related();
	}
