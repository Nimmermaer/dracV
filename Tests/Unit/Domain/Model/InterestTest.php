...
/**
 * Test case for class \PHTH\Dracv\Domain\Model\Interest.
 *
 ...
 */
class InterestTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \PHTH\Dracv\Domain\Model\Interest
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \PHTH\Dracv\Domain\Model\Interest();
	}
